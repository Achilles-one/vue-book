      ...
      <el-dialog title="提示" v-model="dialogVisible" width="30%">
        <el-form :model="form" label-width="120px">
          ...
          <el-form-item label="价格">
            <el-input v-model.number="form.price" style="width: 80%"></el-input>
          </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      pageSize: 10,
      total: 0,
      tableData: [ {id: 1, name: "CSS", price: 36, author: "大佬", createTime: "2020-12-3"} ],
  ...
  created() {
    ...
    // request.get("/user/?id=" + this.user.id).then(res => {
    //   if (res.code === '0') {
    //     this.user = res.data
    //   }
    // })
